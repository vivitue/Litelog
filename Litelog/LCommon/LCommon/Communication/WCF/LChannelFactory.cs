...
namespace L.vivitue.Common.WCF
{
    public class LChannelFactory<T> : ChannelFactory<T>
    {
        ...
        public LChannelFactory(string configpath)
            : base(typeof(T))
        {
        ...
        /// <param name="configpath"></param>
        public LChannelFactory(Binding binding, string configpath)
            : this(binding, (EndpointAddress)null, configpath)
        {
        }
        ...
        /// <param name="configpath"></param>
        public LChannelFactory(ServiceEndpoint endpoint, string configpath)
            : base(typeof(T))
        {
            this.configpath = configpath;
        ...
        /// <param name="configpath"></param>
        public LChannelFactory(string endpointCfgname, string configpath)
            : this(endpointCfgname, null, configpath)
        {
            // nop
        }
        ...
        /// <param name="configpath"></param>
        public LChannelFactory(Binding binding, EndpointAddress epAddr, string configpath)
            : base(typeof(T))
        {
            this.configpath = configpath;
        ...
        /// <param name="configpath"></param>
        public LChannelFactory(Binding binding, string remoteAddr, string configpath)
            : this(binding, new EndpointAddress(remoteAddr), configpath)
        {
        }
        ...
        /// <param name="epAddr"></param>
        /// <param name="configpath"></param>
        public LChannelFactory(string endpointCfgname, EndpointAddress epAddr, string configpath)
            : base(typeof(T))
        {
            this.configpath = configpath;
            this.endpointCfgname = endpointCfgname;
            base.InitializeEndpoint(this.endpointCfgname,epAddr);
        }
        ...
        /// <param name="element"></param>
        /// <returns></returns>
        [Obsolete("Warning : use GetIdentityForVivitue instead!")]
        ...
        private Binding CreateBinding(string bindingName, ServiceModelSectionGroup modelGroup)
        {
            ...
            {
                Innerlig.Error(dclringType, "CreateBinding failed!", ex);
            }
            return null;
        }
        ...
        private bool AddBehaviors(string behaviorCfg, ServiceEndpoint servicep, ServiceModelSectionGroup modelGroup)
        {
            ...
            {
                Innerlig.Error(dclringType, "Behaviors info added failed!", ex);
                return false;
            }
        ...
        /// <summary>
        /// Check config file invalidation
        /// </summary>
        /// <param name="configpath"></param>
        /// <returns></returns>
        ...
        private EndpointAddress epAddr = null;
        #endregion
    }
}
